...
####################################################################################################################
####################################################################################################################
#HLTPath = "HLT_BIT_HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2"
#hPostFix = "6j2t"
#maxmum = 0.3

HLTPath = "HLT_BIT_HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0"
hPostFix = "4j3t"
maximum = 0.15
...
tree.Project("hnum_ttH","ht30","HLT_BIT_HLT_IsoMu27 && {0}  && (run>= 299337 && run<= 302029)".format(HLTPath))
...
hnum_mini = miniFile.Get("hnum_"+str(hPostFix))
...
leg.Draw("same")
cGraph.Update()
cGraph.SaveAs("compTriggerTurnOnMinittHbb13_{0}_graphs.pdf".format(hPostFix))
...
leg.Draw("same")
cDenom.Update()
cDenom.SaveAs("compTriggerTurnOnMinittHbb13_{0}_denom.pdf".format(hPostFix))
...
leg.Draw("same")
cNum.Update()
cNum.SaveAs("compTriggerTurnOnMinittHbb13_{0}_num.pdf".format(hPostFix))
